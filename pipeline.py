...
LUA_SHA1 = get_hash(os.path.join(CWD, 'veoh.lua'))
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/3/30/Veoh-icon.jpeg" height="50px" title=""/>
        <h2>Veoh <span class="links"><a href="https://veoh.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/veoh/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Veoh">Wiki</a></span></h2>
        <p>Archiving Veoh.</p>
    '''
)
